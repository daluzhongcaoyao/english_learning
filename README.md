...
不定式含有还没做的意思，在句子中可以用来表示目的，如：  
He went home `to eat` breakfast. (他回家，为了回家后吃早饭)  

现在分词含有正在做的意思，在句子中可以表示同时做，译为"一边..一边.."，如：  
He went home `eating` breakfast. (他一边走路一边吃早饭)  

过去分词含有做完了的意思，在句子中可以表示动作先后顺序：  
...
普通助动词也叫基本助动词，主要作用是表示"时间"，总共只有3个，be，have，do

具体使用哪个，取决于要给哪个状态做助动词。
...
把字句：I paint the wall white.  
被字句：The wall is painted white by me.
...
如果以后你在句子里面看到动词前面有很多助动词，记得他们可能是组合形态，分解后再各自理解，会容易很多。
...
> 如果没有被动助动词，那时态体现在普通助动词+动词本身上。如果连普通助动词都没有，那只可能是一般现在时或一般过去时了。  
...
于是你开始堆砌"高级"单词，改被动语气，插从句，模仿长难句写很长很长的句子，能读到断气那种，但还是没内味儿。
