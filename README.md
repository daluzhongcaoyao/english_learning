...
> 这里说个有趣的规律。如果一个动作持续时间非常短，短到几乎是瞬间发生，我们用一般时表示。(The car stops，这俩车瞬间就停下了)  
> 如果这个动作重复多次，或者会持续一段时间，我们用进行时表示。(The train is stopping，火车慢慢停下了)  
> 但是如果这个动作重复的次数非常多，以至于成为规律，我们又要用一般时表示。(The bus stops at every station，公交车每站都停)  
...
意思是截止到这个时间，雪**一直**在下(has been)。什么时候开始下的？不知道。而且这个雪还会**继续**下(be snowing)，什么时候结束？也不知道。这就是完成进行时。
...
状态概念，完成/进行/不定态，强调该动作做完了/正在做/还没做。一般时表示瞬态或常态。
...
句子中**只包含状态信息**的动词是非谓语动词。

我们知道，动作的状态总共就3种，还没做，正在做，做完了。所以非谓语动词总共也就3种：
...
注意，虽然名字叫现在分词过去分词，但他们仍然是指动作的状态，**不是动作的时间**，这点一定要注意。
...
```
吐槽下，英语的术语真的不是用来增加学习难度的吗！一个非谓语动词整这么多术语，头都大了！!
```

3.2 谓语动词

句子中**同时包含时间信息和状态信息**的动词是谓语动词。
...
停停停，这里术语太多信息量太大，我知道没听懂，我们另起一节来说说助动词
