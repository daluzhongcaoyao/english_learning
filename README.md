...
I write the blog. 这里的write不是瞬态也不是常态，更不是还没做，正在做，做完了，这描述的是一种**事实**(要用无感情的，旁白的语气念出来)
...
这句里，Eatten只有状态，并且是完成态，是过去分词，做修饰。  
went是did go合并后的一般过去时动词，是过去式，做谓语。
...
> 这里的动词原形有2种说法，一种观点认为这是表示常态，用的是一般态。另一种观点认为这是省略to的不定态。  
...
The car stopping there must have been **very carefully as a serious man as he is** repaired by him.
