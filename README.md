...
我走过的弯路，自然不会让你再走一遍。我在正文中会尽量避免使用这些术语，并慢慢解释他们的含义。
...
如果动词描述的是常态或瞬态，我们就称之为无状态。无状态使用一般时来表达。

回到刚才的问题，Now I tell you why. 为什么错了？
...
> 剧透下，刚刚小剧场的第二种情况，其实就是语法里的"虚拟语气"，我们后面还会细说。
